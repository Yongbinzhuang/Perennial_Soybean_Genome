...
open(OUT1,">2nd.low2high.has.hit") or die "Can't open the output file1,\n";
open(OUT2,">2nd.low2high.no.hit.multiple") or die "Can't open the output file1,\n";
open(OUT3,">2nd.low2high.no.hit.singleton") or die "Can't open the output file1,\n";
