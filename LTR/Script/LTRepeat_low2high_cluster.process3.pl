...
open(OUT1,">3rd.low2high.has.hit") or die "Can't open the output file1,\n";
open(OUT2,">3rd.low2high.no.hit.multiple") or die "Can't open the output file1,\n";
open(OUT3,">3rd.low2high.no.hit.singleton") or die "Can't open the output file1,\n";
